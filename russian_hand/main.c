...
void first_move(){
    static int up_first_alg_finger1[] = {80, 5, LEDC_CHANNEL_2};
    static int down_first_alg_finger1[] = {5, 80, LEDC_CHANNEL_2};
    static int up_first_alg_finger2[] = {95, 23, LEDC_CHANNEL_4};
    static int down_first_alg_finger2[] = {23, 95, LEDC_CHANNEL_4};
...
void second_move(){
    static int up_second_alg_finger1[] = {80, 40, LEDC_CHANNEL_1};
    static int down_second_alg_finger1[] = {40, 80, LEDC_CHANNEL_1};
    static int up_second_alg_finger2[] = {78, 5, LEDC_CHANNEL_0};
    static int down_second_alg_finger2[] = {5, 78, LEDC_CHANNEL_0};
...
void third_move(){
    static int up_third_alg_finger1[] = {80, 5, LEDC_CHANNEL_2};
    static int down_third_alg_finger1[] = {5, 80, LEDC_CHANNEL_2};
    static int up_third_alg_finger2[] = {78, 5, LEDC_CHANNEL_0};
    static int down_third_alg_finger2[] = {5, 78, LEDC_CHANNEL_0};
...
void app_main(void) {
    ...
    config_channel(LEDC_CHANNEL_0, GPIO_NUM_21, 5); // Мизинец
    config_channel(LEDC_CHANNEL_1, GPIO_NUM_12, 80); // Большой
    config_channel(LEDC_CHANNEL_2, GPIO_NUM_11, 5); // указательный
    config_channel(LEDC_CHANNEL_3, GPIO_NUM_13, 40); // безымянный
    config_channel(LEDC_CHANNEL_4, GPIO_NUM_46, 95); // средний
